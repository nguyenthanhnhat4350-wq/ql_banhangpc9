...
import { imageMap } from '../../utils/imageKey';
import './Cart.css';
...
const Cart = () => {
  ...
  const calculateTotal = () => {
    return cartItems.reduce((total, item) => {
      // Đã sửa: Lấy thẳng item.price là số để tính toán
            ...
            return (
              <div key={item.id} className="cart-item">
                ...
                <div className="cart-item-info">
                  ...
                  {/* Đã sửa: Sử dụng formatPrice để hiển thị giá đẹp mắt */}
